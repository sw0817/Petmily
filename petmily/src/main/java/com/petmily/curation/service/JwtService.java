...
public class JwtService {
	...
	private Long expireMin = 300L;  // 세션 유효기간 300분
...
//		Payload 설정
		jwtBuilder
			...
			.claim("user", memberDto).claim("greeting", "환영합니다. " + memberDto.getUser_name()); // 담고 싶은 정보 설정.
// 		로그인시 ,f5를 누르면 새로운 페이지가 로딩되는 것이지 로그인이 풀린것이 아니다
//		signature 설정
